...
public class Contacto {
	 ...
	 */
	public Contacto(String nombre, String telefono, String direccion, String correoElectronico)
			throws FormatoIntroducidoException {
		setNombre(nombre);
	...
	public void setTelefono(String telefono) throws FormatoIntroducidoException {
		if (!telefono.matches("^[6-7|9]{1}[0-9]{8}$"))
			throw new FormatoIntroducidoException(
					"Formato de teléfono incorrecto. Debe tener 9 dígitos y empezar por 6,7 y 9.");
