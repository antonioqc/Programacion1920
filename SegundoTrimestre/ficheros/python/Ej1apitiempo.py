...
def peticion(ciudad):
    ...
    URL_BASE = "https://api.openweathermap.org/data/2.5/forecast?"
    ARGS = {'q': ciudad, 'appid': '5f21175a704694f2f5caf1ded27d8577', 'lang': 'es', 'units': 'metric'}
...
def mostrar_html(ciudad):
    ...
    nombre_archivo = ciudad + "" + peticion(ciudad)['list'][0]['dt_txt'] + "" + peticion(ciudad)['list'][39][
        'dt_txt'] + ".html"
    # nombre_archivo = (medicion['city']['name']) + "" + (medicion['list']['0']['main']['dt_txt']) + "" + (medicion[
    # 'list']['39']['main']['dt_txt']) + ".html"
