...
public class Ej3MetodoCesarControlador implements Initializable{
  ...
  private Button btnDesencripta;
    ...
    try {
      ...
      while ((linea=fichero.readLine()) != null) {
        textoDesencriptado.setText(textoDesencriptado.getText() + MetodoCesar.desencriptaCesar(linea, Integer.parseInt(clave.getText())) + "\n"); 
      }
    } catch (Exception e){
