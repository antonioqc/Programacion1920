...
public class Ej1AdivinaNumeroConForControlador implements Initializable {
	...
	public void comprobar(ActionEvent e) {
		...
		try {
			...
			alert.setHeaderText("Tipo de dato errÓneo");
			alert.setContentText("Debes introducir un valor numérico.");
			alert.showAndWait();
